...
Submitted by: Lindsey Xu

**Color Change Buttom** is an app that when you click on the button, the button changes the screen color to a random color.
...
[Guide]](<video controls src="prework.mp4" title="prework"></video>) .

## App Brainstorming (Step 4)
- [x] Make a list of your favorite 3–5 applications and identify 2–3 features that make them your favorite app.  
      It's okay if features repeat on different apps.
...
Xcode view differs a little from how the instruction described.


## License

    Copyright [2025] [Lindsey Xu]
